    ...
    <nav className="fixed top-0 left-0 right-0 z-50 px-8 pt-4">
      <div className={`max-w-[64rem] mx-auto transition-all duration-300 rounded-2xl px-4 py-2 grid grid-cols-[auto_1fr_auto] items-center gap-4 ${
        ...
        <div className="flex items-center gap-2">
          <Link to="/login" className="hidden sm:inline-block text-[14px] text-white px-4 py-2 no-underline hover:opacity-70 transition-opacity">
            Sign In
          </Link>
      ...
      {menuOpen && (
        <div className="md:hidden max-w-[64rem] mx-auto mt-2 bg-[#99a0ae1a] backdrop-blur-[10px] border border-[#99a0ae1a] rounded-2xl p-4 space-y-1">
          ...
          <Link to="/login" className="block text-[15px] text-white py-2.5 px-3 no-underline">Sign In</Link>
...
function Pricing() {
  ...
  const plans = [
    ...
    { name: 'FBO Pro', price: annual ? '$159' : '$199', period: annual ? '/mo billed annually' : '/mo', popular: true, features: ['Everything in Starter', 'Live ADS-B arrivals map', 'Fuel price management', 'Over-wing / into-plane settings', 'Analytics and reporting', 'Priority listing in pilot app'] },
